...
{
    public partial class EnterpriseReviewElementTemplateVM : BaseTemplateVM
    {
        [Display(Name = "要素名称")]
        public ExcelPropety ElementName_Excel = ExcelPropety.CreateProperty<EnterpriseReviewElement>(x => x.ElementName);
        [Display(Name = "要素类别")]
        public ExcelPropety Category_Excel = ExcelPropety.CreateProperty<EnterpriseReviewElement>(x => x.Category);
        [Display(Name = "级别")]
    ...
    public class EnterpriseReviewElementImportVM : BaseImportVM<EnterpriseReviewElementTemplateVM, EnterpriseReviewElement>
    {
