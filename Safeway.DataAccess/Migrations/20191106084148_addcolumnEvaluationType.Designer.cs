...
namespace Safeway.DataAccess.Migrations
{
    ...
    [Migration("20191106084148_addcolumnEvaluationType")]
    partial class addcolumnEvaluationType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Safeway.Model.Evaluation.DetailNotmalEntEvaluation", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("EvaluationSelection");

                    b.Property<Guid>("NormalEntEvaluationId");
                    ...
                    b.HasIndex("NormalEntEvaluationId");

                    b.ToTable("DetailNotmalEntEvaluations");
                });

            modelBuilder.Entity("Safeway.Model.Evaluation.NormalEntEvaluation", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid>("NormalEntEvaId");

                    b.Property<Guid>("NormalEntEvaTempId");
                    ...
                    b.HasIndex("NormalEntEvaTempId");

                    b.ToTable("NormalEntEvaluations");
                });

            modelBuilder.Entity("Safeway.Model.Evaluation.NormalEntEvaluationTemplate", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("NormalEntEvaluationTemplates");
                });
            ...
            modelBuilder.Entity("Safeway.Model.Evaluation.DetailNotmalEntEvaluation", b =>
                {
                    b.HasOne("Safeway.Model.Evaluation.NormalEntEvaluation", "NormalEntEvaluation")
                        .WithMany("DetailNotmalEntEvaluations")
                        .HasForeignKey("NormalEntEvaluationId")
            ...
            modelBuilder.Entity("Safeway.Model.Evaluation.NormalEntEvaluation", b =>
                {
                    b.HasOne("Safeway.Model.Evaluation.NormalEntEvaluationTemplate", "NormalEntEvaluationTemplate")
                        .WithMany("NormalEntEvaluations")
                        .HasForeignKey("NormalEntEvaTempId")
            ...
            modelBuilder.Entity("Safeway.Model.Evaluation.NormalEntEvaluationTemplate", b =>
                {
                    b.HasOne("Safeway.Model.Enterprise.EnterpriseBasicInfo", "EnterpriseBasicInfo")
                        .WithOne("NormalEntEvaluationTemplate")
                        .HasForeignKey("Safeway.Model.Evaluation.NormalEntEvaluationTemplate", "EnterpriseId")
